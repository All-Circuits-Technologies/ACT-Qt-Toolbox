...
QVector<StopBits::Enum> StopBits::enumList = {};


StopBits::Enum StopBits::parseFromString(const QString &strValue)
{
...
QString StopBits::toString(StopBits::Enum stopBits)
{
    return QString::fromLatin1(QMetaEnum::fromType<Enum>().valueToKey(stopBits));
}

const QVector<StopBits::Enum> &StopBits::getAllEnums()
{
    if(enumList.isEmpty())
    {
